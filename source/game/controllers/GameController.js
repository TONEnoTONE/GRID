...
var GameController = {
	...
	*/
	setStageAnimated : function(stage, level){
		...
		GameController.showPatternHints(stage < CONST.NO_HINTS_LEVEL);
	},
	...
	*/
	showPatternHints : function(useHints){
		GameScreen.showHints(useHints);
		PatternController.showHints = useHints;
	},
	/*=========================================================================
		COMPUTE
	=========================================================================*/
